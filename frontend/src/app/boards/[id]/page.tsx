...
export default function BoardDetailPage() {
  ...
  const [creatingCardInList, setCreatingCardInList] = useState<string | null>(
    null,
  );
                        ...
                        <Droppable droppableId={list.id} type="card">
                          {(cardDroppableProvided, cardDroppableSnapshot) => (
                            ...
                            >
                              ...
                              <div
                                className={`flex-1 overflow-y-auto space-y-2 mb-4 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent ${
                                  list.cards.length === 0
                              ...
                              {creatingCardInList === list.id ? (
                                <div className="bg-white rounded-lg p-3 shadow-sm border-2 border-blue-300">
                                  ...
                                  <p className="text-xs text-gray-500 mt-2">
                                    Press Enter to add • Ctrl+Enter in
